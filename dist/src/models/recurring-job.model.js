...
const recurringJobSchema = new mongoose_1.Schema({
    ...
    startDate: { type: Date },
    endDate: { type: Date },
    childJobs: [{ type: mongoose_1.Schema.Types.ObjectId, ref: 'Jobs' }],
}, { timestamps: true });
exports.default = mongoose_1.default.model('RecurringJob', recurringJobSchema);
