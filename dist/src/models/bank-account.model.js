...
const bankAccountSchema = new mongoose_1.Schema({
    userId: { type: mongoose_1.Schema.Types.ObjectId, ref: "Users", required: true, index: true },
    bankName: { type: String, required: true, trim: true },
    bankCode: { type: String, required: true },
    accountNumber: { type: String, required: true },
    accountName: { type: String, required: true, trim: true },
    recipientCode: { type: String, required: true },
    currency: { type: String, enum: transaction_enum_1.WalletEnum, default: transaction_enum_1.WalletEnum.NGN },
